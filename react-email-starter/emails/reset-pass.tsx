...
export const DropboxResetPasswordEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>CTRL + FICTION reset your password</Preview>
        <Container style={container}>
          <Img src={`${baseUrl}/static/dropbox-logo.png`} width="40" height="33" alt="Dropbox" />
          <Section>
            <Text style={text}>Hi {userFirstname},</Text>
            <Text style={text}>
              Someone recently requested a password change for your Ctrl + Fiction account. If this
            ...
            <Text style={text}>Let&apos;s Read Books!</Text>
          </Section>
        </Container>
      </Body>
    </Html>
