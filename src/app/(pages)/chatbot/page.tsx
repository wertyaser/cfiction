            ...
            <ChatBubble variant="received">
              ...
              <ChatBubbleMessage className="flex items-center space-x-2">
                <span className="">
                  ...
                  typically require human thinking, such as problem-solving,
                  learning, reasoning, and decision-making. AI systems can be
                  rule-based (traditional programming) or use machine learning,
                  where they learn from data and improve over time. There are
                  different types of AI: Narrow AI (Weak AI) Designed for
                  specific tasks, like chatbots, trading bots, or recommendation
                  systems (e.g., Netflix suggestions).
                </span>
